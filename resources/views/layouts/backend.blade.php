            ...
            <div class="js-sidebar-scroll  ">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        {{-- SAN PHAM --}}
                        @if (Auth::user()->hasAnyRole(['xem danh sách sản phâm', 'xem danh sách danh mục']))
                            <li
                        ...
                        {{-- THUOC TINH --}}
                        @if (Auth::user()->hasAnyRole(['xem danh sách thuộc tính', 'xem danh sách giá trị thuộc tính']))
                            <li
                        ...
                        {{-- @if (Auth::user()->hasAnyRole(['xem danh sách khách hàng', 'xem danh sách nhân viên', 'xem danh sách vai trò'])) --}}
                        {{-- USER --}}
                        <li
