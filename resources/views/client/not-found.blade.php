        ...
        <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto text-center">
            <div class="error-content py-4">
                <div class="four0-img">
                    ...
                    <circle class="cls-14" cx="847.7" cy="247.59" r="63.44" transform="translate(-32.91 314.05) rotate(-20.6)"/>
                ...
                <h2 class="fs-4 mt-4">Oops! Trang bạn tìm kiếm không được tìm thấy</h2>
                <p class="mb-4">Trang bạn đang tìm kiếm đã bị xóa, đổi tên hoặc có thể chưa bao giờ tồn tại.</p>
                <p class="same-width-btn"><a href="{{ session('previous_url', url('/')) }}" class="btn btn-secondary btn-lg mb-2 mx-3">Quay lại</a><a href="{{route("home")}}" class="btn btn-lg mb-2">Tiếp tục mua hàng</a></p>
            </div>
        </div>
    </div>
  </div>
