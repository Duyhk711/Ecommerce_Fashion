...
(function ($) {
    ...
    if ($(window).width() > 992) {
      if ($(".main-menu-outer").hasClass("header-fixed")) {
        ...
        if (nav.length) {
          var offsetTop = nav.offset().top,
            headerHeight = nav.height(),
            injectSpace = $("<div />", { height: headerHeight }).insertAfter(
              nav
            );
          injectSpace.hide();
          $(window).on("load scroll", function () {
  ...
  function account_links() {
    ...
    $("body").on("click", function (e) {
      var t = $(e.target);
      t.parents().is("#accountBox") ||
        t.parents().is(".account-link") ||
        t.is(".account-link") ||
  ...
  function usermenu_dropdown() {
    ...
    $("body").on("click", function (e) {
      var t = $(e.target);
      t.parents().is(".user-links") ||
        t.parents().is(".user-menu") ||
        t.is(".user-menu") ||
  ...
  $("[data-countdown]").each(function () {
    ...
    $this.countdown(finalDate, function (event) {
      $this.html(
        event.strftime(
          '<span class="ht-count days"><span class="count-inner"><span class="time-count">%-D</span> <span class="text">Days</span></span></span> <span class="ht-count hour"><span class="count-inner"><span class="time-count">%-H</span> <span class="text">Hr</span></span></span> <span class="ht-count minutes"><span class="count-inner"><span class="time-count">%M</span> <span class="text">Min</span></span></span> <span class="ht-count second"><span class="count-inner"><span class="time-count">%S</span> <span class="text">Sc</span></span></span>'
        )
      );
    });
  });
  ...
  $(".morelist").each(function () {
    ...
    if (LiN > 3) {
      ...
      $(this).append('<li class="more">Hiển thị thêm</li>');
    }
  });
  $(".morelist").on("click", ".more", function () {
    if ($(this).hasClass("less")) {
      ...
      $(this).text("Ẩn bớt").addClass("less");
    }
  ...
  function grid_options() {
    ...
    $(".grid-4").on("click", function () {
      $(".product-options")
        ...
        .addClass("row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2");
    });
